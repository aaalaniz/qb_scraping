...
data.log.w_combine.for_wins = data.frame(log(na.omit(cbind(wins, college_stats)) + 0.1))
...
leaps.log.w_combine.wins <- regsubsets(wins ~. ,data = data.log.w_combine.for_wins, nbest=10)
